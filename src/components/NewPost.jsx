        ...
        <div>
            <div className="bg-white shadow rounded-md p-4">
                ...
                <div className="mt-2">
                    ...
                    />
                    { postMedia && <img src={postMedia} className="w-full h-auto rounded-md p-2" alt="post"/>}
                </div>
                <div className="flex justify-end">
                    ...
                    <button 
                        ...
                        className="text-sm px-4 py-1 mr-4 font-medium text-blue-600 rounded border border-blue cursor-pointer">
                            {isLoading ?  <i className="animate-spin bx bx-loader-alt font-thin"></i> : "Upload Image"}
                    </button>
                    <button 
                        ...
                        className="bg-blue-600 text-white hover:bg-blue-700 px-4 py-1 rounded">
                            {postStatus === "posting"? <i className="animate-spin bx bx-loader-alt font-thin"></i> : "Post"}
                    </button>
                </div>
            </div>
        </div>

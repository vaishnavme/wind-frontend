...
export default function SignUp() {
    ...
    return (
        <div className="flex items-center h-screen">
            <div className="bg-dark-800 w-96 m-auto my-10 shadow-xl rounded-md">
            <div className="py-4 px-4">
                ...
                <p className="mt-4 text-sm text-center font-normal text-gray-100"> Already have an account? <Link to="/login" className="text-white font-medium"> Log In </Link></p> 

...
import { Login, SignUp, Feed, Explore, Profile, Settings, Following, Followers, PostDetails, Notifications } from "./features";
       ...
       <div className={`md:ml-0 ${isAuthenticated && "md:ml-72 lg:mr-72"}`}>
        <div className="p-2 my-16 max-w-3xl mx-auto">
            <Routes> 
              ...
              <PrivateRoute path="/notify" element={<Notifications/>}/>
